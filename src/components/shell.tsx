...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    void syncState().finally(() => setIsBooting(false));
  ...
  if (isBooting && !hideShellExtras) {
    return (
      <div className="min-h-screen bg-[#f7f9fc] text-slate-900">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="mb-6 rounded-[28px] border border-slate-200/80 bg-white p-4 shadow-sm sm:p-6">
